...
class StableDiffusionBEVWrapper(nn.Module):
    ...
    def forward(self, x, timesteps, H=128, W=128, D=16, y=None, context=None, data=None):
        """
        ...
        return self.model(x, timesteps=timesteps, context=context, y=y, H=H, W=W, D=D, data=data)
